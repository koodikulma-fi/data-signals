...
export interface ContextAPI<Contexts extends ContextsAllType = {}> extends DataBoy<Partial<GetPartialDataFromContexts<Contexts>>, 1>, SignalMan<GetSignalsFromContexts<Contexts>> { }
...
export class ContextAPI<Contexts extends ContextsAllType = {}> extends (mixinDataBoy(mixinSignalMan(Object)) as any as ReClass<ContextAPIType, {}>) {
    ...
    */
    public setInData<CtxDatas extends GetPartialDataFromContexts<Contexts>, CtxDataKey extends GetJoinedDataKeysFrom<CtxDatas, 1>, SubData extends PropType<CtxDatas, CtxDataKey, never>>(ctxDataKey: CtxDataKey, data: Partial<SubData> & Record<string, any>, extend?: true, refresh?: boolean, forceTimeout?: number | null): void;
